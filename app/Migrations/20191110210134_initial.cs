    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostsArchive", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PostsArchive_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostsArchive_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostsArchive_RoomId",
                table: "PostsArchive",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_PostsArchive_UserId",
                table: "PostsArchive",
                column: "UserId");
